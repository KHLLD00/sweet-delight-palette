...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ease Cakes & Pastries" },
      {
        name: "description",
        content: "Ease Cakes & Pastries, cakes and pastries in Lokoja.",
      },
      { name: "author", content: "Ease Cakes & Pastries" },
      { property: "og:title", content: "Ease Cakes & Pastries" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Caveat:wght@500;600&family=Fraunces:ital,opsz,wght@0,9..144,500;0,9..144,600;1,9..144,500&family=Work+Sans:wght@300;400;500;600&display=swap",
      },
